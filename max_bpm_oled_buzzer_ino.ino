...
Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT, &I2C_2, OLED_RESET); //Declaring the display name (display)
...
void setup() {
  ...
  delay(3000);
  // Initialize sensor
  particleSensor.begin(I2C_1, I2C_SPEED_FAST); //Use default I2C port, 400kHz speed
